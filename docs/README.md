...
|---|---|---|
| [OTP_SETUP.md](OTP_SETUP.md) | Project developers and realm administrators | End-to-end project setup, including the required installer script, for the shared realm or a different realm/server |
